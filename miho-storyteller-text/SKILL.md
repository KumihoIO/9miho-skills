---
name: miho-storyteller-text
description: Write web novels, shooting scripts or text storyboards from Storyteller Canon — fetch a pinned writing packet, author the prose in this conversation, and submit it to Text Studio for rendering and review without another model run.
tags: [9miho, storyteller, text, webnovel, screenplay, writing, authoring, production, review]
---

# miho-storyteller-text
...
Add `detail=` for anything specific — `get_skill(task="text",
